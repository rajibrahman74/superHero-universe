        ...
        >
          {heroImage.map((image, index) => (
            ...
            >
              ...
              {hoveredIndex === index && (
                <button
                className="absolute md:top-[115px] md:left-[150px] transform -translate-x-1/2 -translate-y-1/2 border-0 bg-warning hover:bg-black text-white px-6 py-2 rounded"
                data-aos="fade-up"
                data-aos-duration="500"
              >
                Buy Now
